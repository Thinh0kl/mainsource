        ...
        try {
            ...
            if (rs.first()) {
                ...
                if (rs.getBoolean("ban")) {
                    Service.gI().sendThongBaoOK(session, "Tài khoản đã bị band, vui lòng liên hệ admin để được giải quyết !");
//                if (rs.getInt("ban")) {
//                    Service.gI().sendThongBaoOK(session, "Phí Kích Hoạt Tài Khoản Là 20K Bạn Nhé ♥!");
                } else if (baotri && session.isAdmin) {
                    Service.gI().sendThongBaoOK(session, "Máy chủ đang bảo trì, vui lòng đợi!");
                    ...
                    if (plInGame != null) {
                        ...
                        Service.gI().sendThongBaoOK(session, "Tài khoản đang đăng nhập nơi khác");
                    } else {
                    }
//                    Service.gI().sendThongBaoOK(session, "Tài khoản đang được đăng nhập tại máy chủ khác");
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            player.mott = rs.getInt("mott");
                            player.moChiTon = rs.getInt("moChiTon");
                            player.chiTon = rs.getInt("chiTon");
                            player.lambanh = rs.getInt("lambanh");
                            ...
                            player.khiultra = rs.getInt("khiultra");
                            player.dsk = rs.getInt("dsk");
                            player.qv = rs.getInt("qv");
                            player.qtt = rs.getInt("qtt");
                            player.gd = rs.getInt("gd");
                            player.tongnap = rs.getInt("tongnap");
                            player.mapmoi = rs.getInt("mapmoi");
                            player.nhanngoc = rs.getInt("nhanngoc");
                            player.ngoccs = rs.getInt("ngoccs");
                            ...
                            if (player.inventory.itemsBody.size() < 15) {//11zzaa
