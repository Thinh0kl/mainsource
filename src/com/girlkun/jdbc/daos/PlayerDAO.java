...
public class PlayerDAO {
    ...
    public static boolean addtn(Player player, int num) {
        PreparedStatement ps = null;
        try (Connection con = GirlkunDB.getConnection();) {
            ps = con.prepareStatement("update player set tongnap = (tongnap + ?) where account_id = ?");
            ps.setInt(1, num);
    ...
    public static boolean subtn(Player player, int num) {
        PreparedStatement ps = null;
        try (Connection con = GirlkunDB.getConnection();) {
            ps = con.prepareStatement("update player set tongnap = (tongnap - ?) where account_id = ?");
            ps.setInt(1, num);
