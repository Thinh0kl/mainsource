...
public class GokuSvip extends Boss {

    public GokuSvip() throws Exception {
        super(Util.randomBossId(), BossesData.Goku_Svip );
    }
    ...
    public void reward(Player plKill) {
        ...
        if (plKill != null  && plKill.getSession().actived) {
            ...
            Service.gI().dropItemMap(this.zone, new ItemMap(zone, 2116, 1, this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id));
