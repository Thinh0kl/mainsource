...
public class zamasfusion2 extends Boss {

    public zamasfusion2() throws Exception {
        super(BossID.ZAMASFUSION2, BossesData.ZAMASFUSION2);
    }
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(40, 100)) {
            ...
            ItemMap mvbt = new ItemMap(this.zone, randomItem, 10, this.location.x, this.location.y, plKill.id);
            Service.gI().dropItemMap(this.zone, mvbt);
        }
        return;
    }
