...
//**************************************************************************
    ...
    public static final BossData ZAMASFUSION = new BossData(
        "Zamasu Fusion", //name
        ...
        new String[]{"|-1|Loài người thật hèn hạ",
            ...
            "|-1|Hãy để ta tiêu diệt các ngươi",
            "|-1|Một thế giới mới sẽ hiện ra",
            "|-2|không ổn rồi ta phải nhờ zeno Sama ở tương lai giúp thôi",
            "|-2|không ổn rồi ta phải nhờ zeno Sama ở tương lai giúp thôi",}, //text chat 2
        new String[]{"|-1|HAHA! TA sẽ sớm trở lại cùng với đồng bọn của ta, các ngươi yên tâm  !!!!!!!!!!!!"}, //text chat 3
        TypeAppear.APPEAR_WITH_ANOTHER
);
    //-------------------------------------------------------------------
    ...
    public static final BossData CHILLER = new BossData(
        ...
        new int[][]{
            ...
            {Skill.MASENKO, 2, 300},},//skill//skill
        new String[]{}, //text chat 1
        new String[]{"|-1|Ngươi là ai mà dám cản đường ta",
            "|-2|Chuyện gì thế này, ta đang ở quá khứ sao?",
            "|-2|Freeza, là tên súc vật nhà ngươi à?",
            "|-2|Không phải, tên này chắc là tổ tiên của hắn ở quá khứ",
            "|-1|Ngươi có biết ta là người mạnh nhất vũ trụ không!",
            "|-2|Hắn mạnh quá, mình không thể đánh nổi",
            "|-1|Mau cút ra chỗ khác để ta làm thịt bọn hành tinh Plant này",
            "|-1|Cút ngay tên sayan kia!"}, //text chat 2
        new String[]{"|-1|Hãy về nó với dòng họ ta, có một chủng tộc tên sayan và có thể biến hình. Hãy tiêu diệt chúng !!!!!!!!!!!!"}, //text chat 3
        REST_30_M
);
    public static final BossData Gohan_Beast = new BossData(
            "GOHAN_BEAST", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1384, 1385, 1386, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000l, //dame
    ...
    public static final BossData Morimata = new BossData(
            "MORIMATA", //name
            ConstPlayer.NAMEC, //gender
    ...
    public static final BossData Goku_Svip = new BossData(
            "GOKU_SVIP", //name
            ConstPlayer.XAYDA, //gender
            ...
            new int[][]{
                ...
                {Skill.ANTOMIC, 7, 500},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
                "|-1|Chán quá!",
                "|-1|Không có ai đủ mạnh để đấu với ta sao?",
    ...
    public static final BossData ONGNOEL = new BossData(
            "Lão Già Noel", //name
            ConstPlayer.XAYDA, //gender
            new short[]{657, 658, 659, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000000000l, //dame
            new long[]{1000000000000l}, //hp
            new int[]{158, 159}, //map join
            new int[][]{
                {Skill.TAI_TAO_NANG_LUONG, 7, 120000},
                {Skill.KHIEN_NANG_LUONG, 3, 60000},
                {Skill.KAMEJOKO, 7, 500},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Địt mẹ bọn mày",
                "|-1|Không muốn nhận quà à!",
                "|-1|Tha cho tao",
                "|-1|Ta sẽ cho ngươi cái nịt!",}, //text chat 2
            new String[]{"|-1|Biến hình !!!!!!!!!!!!"}, //text chat 3
            REST_30_M
    );
    public static final BossData SKNOEL = new BossData(
            "Thằng Già Noel", //name
            ConstPlayer.XAYDA, //gender
            new short[]{657, 658, 659, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000l, //dame
            ...
            new String[]{"|-1|Quà nè",
                "|-1|Đến đây mà bú!",
                "|-1|Bú cặc tao đi",
                "|-1|Bọn ngu!",}, //text chat 2
            new String[]{"|-1|Biến hình !!!!!!!!!!!!"}, //text chat 3
            REST_10_M
    );
    public static final BossData RONGVANG = new BossData(
            "Vệ Thần Mùa Xuân", //name
            ConstPlayer.NAMEC, //gender
            ...
            new int[][]{
                {Skill.BIEN_KHI, 7, 300000},
                {Skill.KHIEN_NANG_LUONG, 7, 60000},
                {Skill.KAMEJOKO, 7, 500},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Năm mới mà bọn mày không nạp à",
                "|-1|Bọn bay chỉ biết cày chay thì sao đánh bại được ta",
                "|-1|Haha, tết dương lịch là ngày tàn của bọn mày",
                "|-1|Giết tao đi có quà nè",
                "|-1|Đầu năm có quà nè mấy chú bé",}, //text chat 2
            new String[]{"|-1|HAHA! TA THỨC TỈNH RỒI !!!!!!!!!!!!"}, //text chat 3
            REST_15_M
    );
    public static final BossData ZENO = new BossData(
            "Vị Thần Tối Cao", //name
            ConstPlayer.NAMEC, //gender
            new short[]{2084, 2085, 2086, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000000000l, //dame
            new long[]{150000000000000l}, //hp
            new int[]{28, 29, 30}, //map join
            new int[][]{
                {Skill.THOI_MIEN, 3, 100000},
            ...
            new String[]{}, //text chat 1
            new String[]{"|-1|GOKU đâu rồi , lại đây đánh nhau 300 hiệp với ta",
                "|-1|Lũ sâu bọ này không có cửa rồi, haha",
                "|-1|Haha, Đánh mỏi tay lắm phải ko mấy cu em",
                "|-1|Ối giời ơi nhìn nó tội chưa kìa",
                "|-1|Ultra Instinct , ta là đấng tối cao đã sáng lập ra chiêu thức này",
                "|-1|Nhờ có ta mà mới có các ngươi",
                "|-1|Ngươi có tin ta chỉ cần búng tay 1 cái, là ngươi bay màu không?",
                "|-1|Vuback , Chiller , Ortega chỉ là những con gà",}, //text chat 2
            new String[]{"|-1|HAHA! TA THỨC TỈNH RỒI !!!!!!!!!!!!"}, //text chat 3
            REST_15_M
    );
    public static final BossData WUKONG = new BossData(
            "Ngộ Không Truyền Kỳ", //name
            ConstPlayer.NAMEC, //gender
            ...
            new String[]{"|-1|Năm Mới Vui Vẻ",
                ...
                "|-1|Năm Mới Vui Vẻ",
                "|-1|Năm Mới Vui Vẻ",
                "|-1|Năm Mới Vui Vẻ",}, //text chat 2
            new String[]{"|-1|HAHA! Nhận Cải Trang Thôi !!!!!!!!!!!!"}, //text chat 3
            REST_15_M
    );

    public static final BossData RONGTAAC = new BossData(
    ...
    public static final BossData HEARTGOD = new BossData(
            "Kelfa", //name
            ConstPlayer.XAYDA, //gender
            ...
            new String[]{}, //text chat 1
            new String[]{"|-1|Ta sẽ hạ gục các ngươi",
                "|-1|Có đồ thiên tử nè, tới đây mà bú",
                "|-1|Haha, Đánh mỏi tay lắm phải ko mấy cu em",
                "|-1|Ối giời ơi nhìn nó tội chưa kìa",
                "|-1|Mấy chú bé này yếu quá, ta khuyên ngươi nên chuyển sinh",
                "|-1|Tốt rồi mấy cu em",
                "|-1|Thấy chưa, có đánh lại ta đâu mà đánh",
                "|-1|Lại là 1 lũ ngu rồi",}, //text chat 2
            new String[]{"|-1|HAHA! Éo Có Gì Đâu. !!!!!!!!!!!!"}, //text chat 3
            REST_15_M
    );

    public static final BossData GOKU4 = new BossData(
            ...
            new String[]{"|-1|GOKU đây",
                "|-1|Có đồ thiên tử VIP nè, tới đây mà bú",
                "|-1|Haha, Đánh mỏi tay lắm phải ko mấy cu em",
                "|-1|CHÚ BÉ ĐẦN CHÚ BÉ ĐẦN CHÚ BÉ ĐẦN ĐẦN ĐẦN ĐẦN ĐẦN ĐẦN ",
                "|-1|NGU NGU NGU NGU NGU",
                "|-1|YẾU QUÁ YẾU",
                "|-1|Gà GÀ GÀ CÔNG NGHIỆP",
                "|-1|Úi dời sao rồi, ko đánh lại đúng ko",}, //text chat 2
            new String[]{"|-1|HAHA!TOANG TA RỒI. !!!!!!!!!!!!"}, //text chat 3
            REST_15_M
    );
    public static final BossData GOKU5 = new BossData(
        "Broly Ngoại Truyện", //name
        ConstPlayer.XAYDA, //gender
        new short[]{1402, 1403, 1404, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
        1000000000000000l, //dame
        new long[]{9000000000000000000l}, //hp
        new int[]{0}, //map join
        new int[][]{
            {Skill.THOI_MIEN, 7, 100000},
            {Skill.KHIEN_NANG_LUONG, 7, 100000},
...
public static final BossData GOKU6 = new BossData(
    "Vegeta Long Nhân", //name
    ConstPlayer.XAYDA, //gender
    new short[]{1273, 1274, 1275, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
    1000000000000000l, //dame
    new long[]{9000000000000000000l}, //hp
    new int[]{7}, //map join
    new int[][]{
...
public static final BossData GOKU7 = new BossData(
    "Goku Long Nhân", //name
    ConstPlayer.XAYDA, //gender
    new short[]{1270, 1271, 1272, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
    1000000000000000l, //dame
    new long[]{9000000000000000000l}, //hp
    new int[]{8}, //map join
    new int[][]{
...
public static final BossData GOKU8 = new BossData(
    "Picolo Long Nhân", //name
    ConstPlayer.XAYDA, //gender
    new short[]{1276, 1277, 1278, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
    1000000000000000l, //dame
    new long[]{9000000000000000000l}, //hp
    new int[]{9}, //map join
    new int[][]{
    ...
    public static final BossData XENDO = new BossData(
            ...
            new int[][]{
                ...
                {Skill.KAMEJOKO, 7, 500},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Haha , Bọn Vừa Nghèo Vừa Yếu",
                "|-1|Bọn bay chỉ biết cày chay thì sao đánh bại được ta",
                "|-1|Haha, mày ngu quá",
                "|-1|Giết tao đi có quà nè",
                "|-1|Mày Ngu Quá , Lũ Nông Dân Ngu Ngốc",}, //text chat 2
            new String[]{"|-1|HAHA! TA ĐÃ QUAY LẠI TRÁI ĐẤT !!!!!!!!!!!!"}, //text chat 3
            REST_15_M
    );
    ...
    public static final BossData SUPER_ANDROID_17 = new BossData(
            ...
            new int[][]{
                ...
                {Skill.TAI_TAO_NANG_LUONG, 1, 50000}, {Skill.TAI_TAO_NANG_LUONG, 3, 100000}, {Skill.TAI_TAO_NANG_LUONG, 7, 150000},
    ...
    public static final BossData KHI_ULTRA = new BossData(
            "Khỉ 8 Ultra", //name
            ConstPlayer.TRAI_DAT, //gender
            ...
            new String[]{"|-1|Vãi cặc !",
                "|-1|Địt mẹ bọn ngu lồn này",
                "|-2|Bọn súc vật ngon thì đấm tao đi ???",
                "|-1|Mày ngu như con chó"
            }, //text chat 1
            new String[]{"|-1|Bố mày địt chết cụ mày giờ",
                "|-1|Ha ha ha! Mắt mày mù à? Nghĩ sao mà đấm tao vậy ???",
                "|-1|Định chạy trốn hả thằng ngu lồn",
                "|-1|Tao địt từng thằng bọn mày",
                "|-1|Hahaha mày đây rồi",
                "|-1|Súc vật khỉ đầu chó"
            }, //text chat 2
            new String[]{"|-2|Đẹp trai nó phải thế"}, //text chat 3
    ...
    public static final BossData GRANOLA = new BossData(
            ...
            new String[]{"|-1|Vãi cặc !",
                "|-1|Địt mẹ bọn ngu lồn này",
                "|-2|Bọn súc vậy ngon thì đấm tao đi ???",
                "|-1|Mày ngu như con chó"
            }, //text chat 1
            new String[]{"|-1|Bố mày địt chết cụ mày giờ",
                "|-1|Ha ha ha! Mắt mày mù à? Nghĩ sao mà đấm tao vậy ???",
