...
public class BossID {
    ...
    public static final int KHI_ULTRA = -19;
...
//   
    ...
    public static final int GOHAN_BEAST = -2520;
    public static final int MORIMATA = -2521;
    public static final int GOKU_SVIP = -2522;
    public static final int GRANOLA = -2523;
    public static final int ONGNOEL = -2524;
    public static final int SKNOEL = -2525;
    public static final int RONGVANG = -2526;
    public static final int XENDO = -2527;
    public static final int ZENO = -2528;
    public static final int ZAMASFUSION = -2529;
    public static final int HEARTGOD = -2530;
    ...
    public static final int SONTINH = -2535;
    public static final int THUYTINH = -2536;
    public static final int GOKU5 = -2537;
