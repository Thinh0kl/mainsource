...
public class Item {
    ...
    public static class ItemOption {
        ...
        public String getOptionStringVIP() {
            return Util.replace(this.optionTemplate.name, "#", String.valueOf(this.param*2));
        }
    ...
    public boolean isDTS() {
        if ((this.template.id >= 1048 && this.template.id <= 1062) || (this.template.id>=2053 && this.template.id<=2065)) {
            return true;
        }
        return false;
    }
    ...
    public boolean isDCT() {
        if ((this.template.id >= 2212 && this.template.id <= 2216)) {
            return true;
        }
        return false;
    }
