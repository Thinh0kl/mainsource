...
public class ItemService {
    ...
    public Item createItemDoThienSu(int tempId, int quantity) {
        Item item = new Item();
        item.template = getTemplate(tempId);
        item.quantity = quantity;
        item.itemOptions = createItemNull().itemOptions;
    ...
    public int randomSKHId(byte gender) {
        if (gender == 3) gender = (byte) Util.nextInt(0,2)  ;
        int[][] options = {{128, 129, 127}, {130, 131, 132}, {133, 135, 134}};
        int skhv1 = 25;
        int skhv2 = 35;
        int skhc = 40;
    ...
    public void OpenSV(Player player,  int select) throws Exception {
        ...
        if(itemUse.template.id == 2106){
        
        Item item = null;
        if(select == 0){
            item.template.id = 2102;
            item.quantity = 50;
            item.itemOptions.add(new Item.ItemOption(30,1));
        } else if(select == 1){
            item.template.id = 2103;
            item.quantity = 50;
            item.itemOptions.add(new Item.ItemOption(30,1));
        } else if(select == 2){
            item.template.id = 2104;
            item.quantity = 50;
            item.itemOptions.add(new Item.ItemOption(30,1));
...
//    }
    ...
    public Item randomCS_DTL(int itemId, int gender) {
        ...
        int nhd = 561;
        if (ao.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(47, Util.highlightsItem(gender == 2, new Random().nextInt(100) + 1000))); // áo từ 1800-2800 giáp
        }
        if (quan.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(22, Util.highlightsItem(gender == 0, new Random().nextInt(10) + 60))); // hp 85-100k
        }
        if (gang.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(0, Util.highlightsItem(gender == 2, new Random().nextInt(2000) + 4000))); // 8500-10000
        }
        if (giay.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(23, Util.highlightsItem(gender == 1, new Random().nextInt(10) + 60))); // ki 80-90k
        }
        if (nhd == itemId) {
            it.itemOptions.add(new Item.ItemOption(14, new Random().nextInt(3) + 12)); //chí mạng 17-19%
        }
        it.itemOptions.add(new Item.ItemOption(21, 15));// yêu cầu sm 80 tỉ
        it.itemOptions.add(new Item.ItemOption(30, 1));// ko the gd
        return it;
    }
    ...
    public Item NCB(int itemId, int gender) {
        Item ncb = createItemSetKichHoat(itemId, 1);
        List<Integer> ao = Arrays.asList(650, 652, 654);
        List<Integer> quan = Arrays.asList(651, 653, 655);
        List<Integer> gang = Arrays.asList(657, 659, 661);
        List<Integer> giay = Arrays.asList(658, 660, 662);
        ...
        //áo
        if (ao.contains(itemId)) {
            ncb.itemOptions.add(new Item.ItemOption(47, Util.highlightsItem(gender == 2, new Random().nextInt(101) + 1000))); // áo từ 2800-4000 giáp
            ncb.itemOptions.add(new Item.ItemOption(30, 1));
            ncb.itemOptions.add(new Item.ItemOption(21, 30));
        }
        //quần
        if (Util.isTrue(80, 100)) {
            if (quan.contains(itemId)) {
                ncb.itemOptions.add(new Item.ItemOption(22, Util.highlightsItem(gender == 0, new Random().nextInt(16) + 95))); // hp 120k-130k
                ncb.itemOptions.add(new Item.ItemOption(27, 50000));
                ncb.itemOptions.add(new Item.ItemOption(30, 1));
                ncb.itemOptions.add(new Item.ItemOption(21, 30));
            }
        } else {
            if (quan.contains(itemId)) {
                ncb.itemOptions.add(new Item.ItemOption(22, Util.highlightsItem(gender == 0, new Random().nextInt(16) + 105))); // hp 130-150k 15%
                ncb.itemOptions.add(new Item.ItemOption(27, 60000));
                ncb.itemOptions.add(new Item.ItemOption(30, 1));
                ncb.itemOptions.add(new Item.ItemOption(21, 30));
            }
        }
        ...
        if (Util.isTrue(80, 100)) {
            if (gang.contains(itemId)) {
               ncb.itemOptions.add(new Item.ItemOption(0, Util.highlightsItem(gender == 2, new Random().nextInt(651) + 9350))); // 9350-10000
               ncb.itemOptions.add(new Item.ItemOption(209, 1));
               ncb.itemOptions.add(new Item.ItemOption(30, 1));
               ncb.itemOptions.add(new Item.ItemOption(21, 30));
            }
        } else {
            if (gang.contains(itemId)) {
                ncb.itemOptions.add(new Item.ItemOption(0, Util.highlightsItem(gender == 2, new Random().nextInt(1001) + 10000))); // gang 15% 10-11k -xayda 12k1
                ncb.itemOptions.add(new Item.ItemOption(30, 1));
                ncb.itemOptions.add(new Item.ItemOption(21, 30));
            }
        }
        ...
        if (Util.isTrue(80, 100)) {
            if (giay.contains(itemId)) {
               ncb.itemOptions.add(new Item.ItemOption(23, Util.highlightsItem(gender == 1, new Random().nextInt(16) + 95))); // ki 90-110k
               ncb.itemOptions.add(new Item.ItemOption(28, 50000));
               ncb.itemOptions.add(new Item.ItemOption(30, 1));
               ncb.itemOptions.add(new Item.ItemOption(21, 30));
            }
        } else {
            if (giay.contains(itemId)) {
                ncb.itemOptions.add(new Item.ItemOption(23, Util.highlightsItem(gender == 1, new Random().nextInt(16) + 105))); // ki 110-130k
                ncb.itemOptions.add(new Item.ItemOption(28, 60000));
                ncb.itemOptions.add(new Item.ItemOption(30, 1));
                ncb.itemOptions.add(new Item.ItemOption(21, 30));
            }
        }
