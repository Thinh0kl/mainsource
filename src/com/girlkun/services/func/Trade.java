...
public class Trade {
    ...
    public void openTabTrade() {
        ...
        try {
            ...
            this.cancelTrade();
            Service.getInstance().sendThongBao(player1, "Bạn hoặc đối phương chưa mở thành viên");
        } 
        } else {
             this.cancelTrade();
            Service.getInstance().sendThongBao(player1, "Bạn hoặc đối phương không thể giao dịch. Vui lòng liên hệ admin");
        }
    }
