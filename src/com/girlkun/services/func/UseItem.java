...
//            Logger.logException(UseItem.class, e);
        ...
        if (item.template.strRequire <= pl.nPoint.power) {
            switch (item.template.type) {
                ...
                case 20:
                    ...
                    // Service.gI().sendThongbao(pl,"Doi ad fix");
                    break;
                ...
                case 17: //chanmenh
                    Item oldItem = pl.inventory.itemsBody.get(11);
                    if (oldItem != null && oldItem.isNotNullItem()) {
                        EffectSkillService.gI().sendEffectPlayerNew(pl, false, (oldItem.template.part));
                    }
                    InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                    EffectSkillService.gI().sendEffectPlayerNew(pl, true, (item.template.part));
                    
                    break;
                case 19: //danhhieu
                    Item oldItem1 = pl.inventory.itemsBody.get(13);
                    if (oldItem1 != null && oldItem1.isNotNullItem()) {
                        EffectSkillService.gI().sendEffectPlayerNew(pl, false, (oldItem1.template.part));
                    }
                    InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                    EffectSkillService.gI().sendEffectPlayerNew(pl, true, (item.template.part));
                ...
                case 18://haoquang
                    InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                    Service.gI().sendMessAllPlayerInMap(pl, null);
                    break;
                default:
                    switch (item.template.id) {
                        ...
                        case 1152:
                            ...
                            break;
                        case 2128:
                            UseItem.gI().usesdbuff1(pl);
                            break;
                        case 2129:
                            UseItem.gI().usehpbuff1(pl);
                            break;
                        case 2130:
                            UseItem.gI().usekibuff1(pl);
                            break;
                        case 1154:
                        ...
                        case 1259:
                            ...
                            break;
                        case 2097:
                            UseItem.gI().qua50k(pl);
                            break;
                        case 2133:
                            UseItem.gI().usequavnd(pl);
                            break;
                        case 2105:
                            UseItem.gI().qua100k(pl);
                            break;
                        case 2110:
                            UseItem.gI().qua200k(pl);
                            break;
                        ...
                        case 1156: //bông tai c4
                            ...
                            break;
                        case 2101: //bông tai c5
                            UseItem.gI().usePorata5(pl);
                            break;
                        case 2119: //bông tai c6
                        ...
                        case 2137:
                            if(pl.mott == 0){
                                Service.gI().sendThongBao(pl, "Bạn chưa mở giới hạn thiên tử"); //đá bảo vệ
                            }else{
                                UseItem.gI().ItemThientu(pl, item);
                            }
                        break;
                        case 2211:
                            if(pl.moChiTon == 0){
                                Service.gI().sendThongBao(pl, "Bạn chưa mở map Chí Tôn"); //đá bảo vệ
                            }else{
                                UseItem.gI().ItemChiTon(pl, item);
                            }
                        break;
                        ...
                        case 2131:
                            ...
                            break;
                        case 2135:
                            useThiepMungXuanThuong(pl,item);
                             break;
                        case 2136:
                            useThiepMungXuanVIP(pl,item);
                            break;
                        case 2006:
    ...
    private void changePetBerus(Player player) {
        ...
        if (player.pet != null) {
            ...
            InventoryServiceNew.gI().subQuantityItemsBag(player,hon, 1);
        } else {
            Service.gI().sendThongBao(player, "Không thể thực hiện");
        }
        } Service.gI().sendThongBao(player, "Không thể thực hiện");
    ...
    private void changePetgohan(Player player) {
     ...
     if(InventoryServiceNew.gI().findItemBag(player, 2114).isNotNullItem() && InventoryServiceNew.gI().findItemBag(player, 2114).quantity >=1){
        ...
        if (player.pet != null) {
            int gender = player.pet.gender;
            PetService.gI().changegohanPet(player, gender);
            InventoryServiceNew.gI().subQuantityItemsBag(player,hon, 1);
        } else {
            Service.gI().sendThongBao(player, "Không thể thực hiện");
        }
    ...
    private void changePetmori(Player player) {
        ...
        if (player.pet != null) {
            int gender = player.pet.gender;
            PetService.gI().changemoriPet(player, gender);
            InventoryServiceNew.gI().subQuantityItemsBag(player,hon, 1);
        } else {
            Service.gI().sendThongBao(player, "Không thể thực hiện");
        }
    ...
    private void usesknoel(Player pl, Item item) {
        try {
            ...
            if (hopquat1nap != null) {
                ...
                if (Util.isTrue(20, 100)) {
                    Item sv1 = ItemService.gI().createNewItem((short) 2128, 1);
                    sv1.itemOptions.add(new Item.ItemOption(30, 1));
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Ngọc SĐ vip đây rồi");
                } else if (Util.isTrue(20, 100)) {
                    Item sv1 = ItemService.gI().createNewItem((short) 2129, 1);
                    sv1.itemOptions.add(new Item.ItemOption(30, 0));
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Ngọc HP vip đây rồi");
                } else if (Util.isTrue(40, 100)) {
                    Item sv1 = ItemService.gI().createNewItem((short) 2130, 1);
                    sv1.itemOptions.add(new Item.ItemOption(30, 0));
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Ngọc KI vip đây rồi");
                } else if (Util.isTrue(5, 100)) {

                    int vnd = Util.nextInt(50000000, 100000000);
                    PlayerDAO.addvnd(pl, vnd);
                    Service.getInstance().sendThongBao(pl, "Bạn đã nhận được" + vnd + "COIN");
                } else if (Util.isTrue(15, 100)) {
                    int vnd = Util.nextInt(5000000, 30000000);
                    PlayerDAO.addvnd(pl, vnd);
                    Service.getInstance().sendThongBao(pl, "Bạn đã nhận được" + vnd + "COIN");
                } else {
                    Service.getInstance().sendThongBao(pl, "Cái nịt đây rồi");
                }
    ...
    private void useThiepMungXuanThuong(Player pl, Item item) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(pl) <= 1) {
                Service.getInstance().sendThongBao(pl, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            ...
            if (hopquat1nap != null) {
                int randomGiap = Util.nextInt(70,150);
                if (Util.isTrue(1, 100)) {
                    Item sv1 = ItemService.gI().createNewItem((short) 2103, 10);
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Nhận Được Ngọc Vip HP nha Chú Bé!");
                } else if (Util.isTrue(1, 100)) {
                    Item sv1 = ItemService.gI().createNewItem((short) 1054, 1);
                    sv1.itemOptions.add(new Item.ItemOption(220, randomGiap));
                    sv1.itemOptions.add(new Item.ItemOption(21, 200));
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Nhận được gang thiên sứ trái đất nha chú bé đần , cày ghê đó");
                } 
                else if (Util.isTrue(1, 100)) {
                    ...
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Nhận được gang thiên sứ namek nha chú bé đần, cày ghê đó");
                }else if (Util.isTrue(1, 100)) {
                    ...
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Nhận được gang thiên sứ XayDa nha chú bé đần, cày ghê đó");
                }else if (Util.isTrue(1, 100)) {
                    Item sv1 = ItemService.gI().createNewItem((short) 2102, 10);
                    InventoryServiceNew.gI().sendItemBags(pl);
                    InventoryServiceNew.gI().addItemBag(pl, sv1);
                    Service.getInstance().sendThongBao(pl, "Bạn Nhận Được Ngọc SĐ VIP nha em iu cua AD");
                } 
                else if (Util.isTrue(1, 100)) {
                    int vnd = Util.nextInt(50000, 100000);
                    PlayerDAO.addvnd(pl, vnd);
                    Service.getInstance().sendThongBao(pl, "Bạn đã nhận được" + vnd + "COIN");
                } else {
                    Service.getInstance().sendThongBao(pl, "Chúc Ngươi Có 1 năm mới Bình An, ta chỉ có lời chúc này dành tặng ngươi thôi. Cảm ơn ngươi nhiều");
                }
                InventoryServiceNew.gI().subQuantityItemsBag(pl, hopquat1nap, 1);
        ...
        if (tempId >= SummonDragon.NGOC_RONG_1_SAO && tempId <= SummonDragon.NGOC_RONG_7_SAO) {
            switch (tempId) {
                ...
                case SummonDragon.NGOC_RONG_3_SAO:
                    ...
                    break;
                default:
                    NpcService.gI().createMenuConMeo(pl, ConstNpc.SUMMON_SHENRON,
    ...
    private void controllerCallRongBang(Player pl, Item item) {
        int tempId = item.template.id;
        if (tempId >= SummonDragon.NGOC_RONG_1_SAO_BANG && tempId <= SummonDragon.NGOC_RONG_7_SAO_BANG) {
            switch (tempId) {
                case SummonDragon.NGOC_RONG_1_SAO_BANG:

                    SummonDragon.gI().openMenuSummonShenronBang(pl, (byte) (tempId - 13));
                    break;
                default:
                    NpcService.gI().createMenuConMeo(pl, ConstNpc.TUTORIAL_SUMMON_DRAGON,
                            -1, "Bạn chỉ có thể gọi rồng 1 sao", "Hướng\ndẫn thêm\n(mới)", "OK");
                    break;
            }
        }
    }
    ...
    private void usePorata6(Player pl) {
        if (pl.pet == null || pl.fusion.typeFusion == 4 || pl.fusion.typeFusion == 6 || pl.fusion.typeFusion == 8 || pl.fusion.typeFusion == 10 || pl.fusion.typeFusion == 12 || pl.fusion.typeFusion == 20 || pl.fusion.typeFusion == 21 || pl.fusion.typeFusion == 22) {
            Service.getInstance().sendThongBao(pl, "Không thể thực hiện");
        } else {
            if (pl.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                pl.pet.fusion6(true);
    ...
    private void usequavnd(Player pl) {
        try{
            if (!pl.getSession().actived) {
                Service.getInstance().sendThongBao(pl, "Bạn phải mở thành viên");
                return;
            }
            if (InventoryServiceNew.gI().getCountEmptyBag(pl) < 1) {
                Service.getInstance().sendThongBao(pl, "Bạn phải có ít nhất 1 ô trống hành trang");
        ...
        for (Item item : pl.inventory.itemsBag) {
            if (item.isNotNullItem() && item.template.id == 2133) {
                itemuse = item;
                break;
            }
        }
        ...
        if (Util.isTrue(10, 100)) {
            if (Util.isTrue(30, 100)) {
                Item itemts = tsskh();
                Service.getInstance().sendThongBao(pl, "Bạn vừa nhận được " + itemts.template.name);
                InventoryServiceNew.gI().addItemBag(pl, itemts);
                InventoryServiceNew.gI().sendItemBags(pl);
            } else if(Util.isTrue(30, 100)){
                
                Item rac = ItemService.gI().createNewItem((short)Util.nextInt(2113, 2115));
                
                if (rac.template.id == 2113) {

                    rac.itemOptions.add(new Item.ItemOption(9, 0));
                }
                rac.quantity = 1;
                Service.getInstance().sendThongBao(pl, "Bạn vừa nhận được " + rac.template.name);
                InventoryServiceNew.gI().addItemBag(pl, rac);
                InventoryServiceNew.gI().sendItemBags(pl);
            }else if(Util.isTrue(10, 100)){
                Item bt = ItemService.gI().createNewItem((short) 2119);
                
                bt.quantity = 1;
                Service.getInstance().sendThongBao(pl, "Bạn vừa nhận được " + bt.template.name);
                InventoryServiceNew.gI().addItemBag(pl, bt);
                InventoryServiceNew.gI().sendItemBags(pl);
            }
        } else if (Util.isTrue(50, 100)) {
            if (Util.isTrue(50, 100)) {
                Item ball = ItemService.gI().createNewItem((short) Util.nextInt(2128, 2130));
                
                if (Util.isTrue(10, 100)) {
                    ball.quantity = Util.nextInt(3, 10);
                } else {
                    ball.quantity = Util.nextInt(1, 2);
                }
                Service.getInstance().sendThongBao(pl, "Bạn vừa nhận được " + ball.template.name);
                InventoryServiceNew.gI().addItemBag(pl, ball);
                InventoryServiceNew.gI().sendItemBags(pl);
            } else {
                Item hopqua = ItemService.gI().createNewItem((short) Util.nextInt(2101, 2103));
               
                if (hopqua.template.id == 2101) {
                    hopqua.quantity = 1;
                } else {
                    hopqua.quantity = Util.nextInt(1, 500);
                }
                Service.getInstance().sendThongBao(pl, "Bạn vừa nhận được " + hopqua.template.name);
                InventoryServiceNew.gI().addItemBag(pl, hopqua);
                InventoryServiceNew.gI().sendItemBags(pl);
            }
        } else if (Util.isTrue(70, 100)) {
            Item thucuoi = ItemService.gI().createNewItem((short) Util.nextInt(2123, 2125));
            
            int rd = Util.nextInt(1, 3);
            if(rd == 1){
                thucuoi.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1,30)));
            }else if(rd == 2){
                thucuoi.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1,30)));
            } else thucuoi.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1,30)));
            Service.getInstance().sendThongBao(pl, "Bạn vừa nhận được " + thucuoi.template.name);
                InventoryServiceNew.gI().addItemBag(pl, thucuoi);
                InventoryServiceNew.gI().sendItemBags(pl);
        } else {
            Service.getInstance().sendThongBao(pl, "Đen quá không được gì rồi " );
        }
                
         InventoryServiceNew.gI().subQuantityItemsBag(pl, itemuse, 1);
         } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void usehpbuff(Player pl) {
        ...
        if (hpbuff != null) {
            ...
            InventoryServiceNew.gI().sendItemBags(pl);
            Service.getInstance().sendThongBaoOK(pl, "HP Gốc của bạn đã tăng  " + 1000);
            Service.getInstance().point(pl);
        }
    }

    private void usehpbuff1(Player pl) {
        Item hpbuff = null;
        for (Item item : pl.inventory.itemsBag) {
        ...
        if (hpbuff != null) {
            ...
            InventoryServiceNew.gI().subQuantityItemsBag(pl, hpbuff, 1);
            InventoryServiceNew.gI().sendItemBags(pl);
            Service.getInstance().sendThongBaoOK(pl, "HP Gốc của bạn đã tăng  " + 10000);
            Service.getInstance().point(pl);
        }
    }
    ...
    private void usesdbuff(Player pl) {
        ...
        if (sdbuff != null) {
            ...
            InventoryServiceNew.gI().sendItemBags(pl);
            Service.getInstance().sendThongBaoOK(pl, "SD Gốc của bạn đã tăng  " + 200);
            Service.getInstance().point(pl);
        }
    }

    private void usesdbuff1(Player pl) {
        Item sdbuff = null;

        for (Item item : pl.inventory.itemsBag) {
            if (item.isNotNullItem() && item.template.id == 2128) {
                sdbuff = item;
                break;
            }
        }
        ...
        if (sdbuff != null) {
            pl.nPoint.dameg += 2000;
            InventoryServiceNew.gI().subQuantityItemsBag(pl, sdbuff, 1);
            InventoryServiceNew.gI().sendItemBags(pl);
            Service.getInstance().sendThongBaoOK(pl, "SD Gốc của bạn đã tăng  " + 2000);
            Service.getInstance().point(pl);
        }
    }
    ...
    private void usekibuff(Player pl) {
        ...
        if (kibuff != null) {
            ...
            InventoryServiceNew.gI().sendItemBags(pl);
            Service.getInstance().sendThongBaoOK(pl, "KI Gốc của bạn đã tăng  " + 1000);
            Service.getInstance().point(pl);
        }
    }

    private void usekibuff1(Player pl) {
        Item kibuff = null;
        for (Item item : pl.inventory.itemsBag) {
        ...
        if (kibuff != null) {
            ...
            InventoryServiceNew.gI().subQuantityItemsBag(pl, kibuff, 1);
            InventoryServiceNew.gI().sendItemBags(pl);
            Service.getInstance().sendThongBaoOK(pl, "KI Gốc của bạn đã tăng  " + 10000);
            Service.getInstance().point(pl);
        }
    }
    ...
    public Item tsskh() {
        ...
        if (item.template.type == 0) {
            item.itemOptions.add(new Item.ItemOption(47, Util.nextInt(5000, 20000)));
            if (gender == 0) {
                int a = Util.nextInt(127, 129);
                item.itemOptions.add(new Item.ItemOption(a, 1));
                item.itemOptions.add(new Item.ItemOption(a+12, 1));
            } else if (gender == 1) {
                int a = Util.nextInt(130,132);
                item.itemOptions.add(new Item.ItemOption(a, 1));
                item.itemOptions.add(new Item.ItemOption(a+12, 1));
            } else if (item.template.type == 2) {
                int a = Util.nextInt(133,135);
                item.itemOptions.add(new Item.ItemOption(a, 1));
                item.itemOptions.add(new Item.ItemOption(a+3, 1));
            }

        } else if (item.template.type == 1) {
            int rd = Util.nextInt(1, 50);
            if (rd == 1 || rd == 2) {
                item.itemOptions.add(new Item.ItemOption(22, Util.nextInt(200, 300)));
            } else if (rd == 99) {
                item.itemOptions.add(new Item.ItemOption(22, Util.nextInt(300, 400)));
            } else {
                item.itemOptions.add(new Item.ItemOption(22, Util.nextInt(10, 200)));
            }
            if (gender == 0) {
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(127, 129), 1));
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(139, 141), 1));
            } else if (gender == 1) {
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(129, 131), 1));
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(142, 144), 1));
            } else if (item.template.type == 2) {
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(133, 135), 1));
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(136, 138), 1));
            }
        } else if (item.template.type == 2) {
            int rd = Util.nextInt(1, 100);
            if (rd == 1 || rd == 2 ) {
                item.itemOptions.add(new Item.ItemOption(220, Util.nextInt(50, 100)));
            } else if (rd == 0) {
                item.itemOptions.add(new Item.ItemOption(220, Util.nextInt(100, 200)));
            } else {
                item.itemOptions.add(new Item.ItemOption(220, Util.nextInt(10, 50)));
            }
            if (gender == 0) {
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(127, 129), 1));
                item.itemOptions.add(new Item.ItemOption(Util.nextInt(139, 141), 1));
            ...
            item.itemOptions.add(new Item.ItemOption(23, Util.nextInt(10, 400)));
            if (gender == 0) {
    ...
    private void qua50k(Player pl) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(pl) <= 2) {
                Service.getInstance().sendThongBao(pl, "Bạn phải có ít nhất 3 ô trống hành trang");
                return;
            }
            Item hopquat1nap = null;
            for (Item item : pl.inventory.itemsBag) {
                if (item.isNotNullItem() && item.template.id == 2097) {
                    hopquat1nap = item;
                    break;
                }
            }
            if (hopquat1nap != null) {
                ...
                if (pl.gender == 0) {
                    Item dtl = ItemService.gI().createNewItem((short) 2094);
                    dtl.quantity = 10;
                    InventoryServiceNew.gI().addItemBag(pl, dtl);
                    InventoryServiceNew.gI().sendItemBags(pl);

                } else if (pl.gender == 1) {
                    Item dtl = ItemService.gI().createNewItem((short) 2095);
                    dtl.quantity = 10;
                    InventoryServiceNew.gI().addItemBag(pl, dtl);
                    InventoryServiceNew.gI().sendItemBags(pl);
                } else {
                    Item dtl = ItemService.gI().createNewItem((short) 2096);
                    dtl.quantity = 10;
                    InventoryServiceNew.gI().addItemBag(pl, dtl);
                    InventoryServiceNew.gI().sendItemBags(pl);
                }

                Item bt = ItemService.gI().createNewItem((short) 1156);
                bt.itemOptions.add(new Item.ItemOption(30, 0));
                Item tv = ItemService.gI().createNewItem((short) 457);
                tv.quantity = 2000000;
                tv.itemOptions.add(new Item.ItemOption(30, 0));
                PlayerDAO.addvnd(pl, 20000000);
                Item hn = ItemService.gI().createNewItem((short) 861, 20000000);// x3
    ...
    private void qua100k(Player pl) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(pl) <= 2) {
                Service.getInstance().sendThongBao(pl, "Bạn phải có ít nhất 3 ô trống hành trang");
                return;
            ...
            Item hopquat1nap = null;
            for (Item item : pl.inventory.itemsBag) {
                if (item.isNotNullItem() && item.template.id == 2105) {
                    hopquat1nap = item;
                    break;
                }
            }
            if (hopquat1nap != null) {
                if (Util.isTrue(50, 100)) {
                    Item bt = ItemService.gI().createNewItem((short) 2101);
                    bt.itemOptions.add(new Item.ItemOption(30, 0));
                    InventoryServiceNew.gI().addItemBag(pl, bt);
                    InventoryServiceNew.gI().sendItemBags(pl);
                    //Service.getInstance().sendThongBao(pl, "Bạn là người may mắn nhận được bông tai cấp 5");
                }
                Item sv = ItemService.gI().createNewItem((short) 2106);
                sv.itemOptions.add(new Item.ItemOption(30, 0));

                PlayerDAO.addvnd(pl, 50000000);
                Item hn = ItemService.gI().createNewItem((short) 861, 50000000);// x3

                InventoryServiceNew.gI().subQuantityItemsBag(pl, hopquat1nap, 1);
                InventoryServiceNew.gI().addItemBag(pl, hn);

                InventoryServiceNew.gI().sendItemBags(pl);
                InventoryServiceNew.gI().addItemBag(pl, sv);
                Service.getInstance().sendThongBao(pl, "Bạn đã nhận được quà. Kiểm tra hành trang");
    ...
    private void qua200k(Player pl) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(pl) <= 1) {
            ...
            Item hopquat1nap = null;
            for (Item item : pl.inventory.itemsBag) {
                if (item.isNotNullItem() && item.template.id == 2110) {
                    hopquat1nap = item;
                    break;
                }
            }
            if (hopquat1nap != null) {
                ...
                Item sv = ItemService.gI().createNewItem((short) 2106, 10);
                sv.itemOptions.add(new Item.ItemOption(30, 0));

                PlayerDAO.addvnd(pl, 500000000);
                Item hn = ItemService.gI().createNewItem((short) 861, 500000000);// x3
    ...
    private void ItemThientu(Player pl, Item item) {//hop qua skh
        NpcService.gI().createMenuConMeo(pl, item.template.id, -1, "Hãy chọn chỉ số Thiên tử", "Thiên tử sát thương", "Thiên tử huyết long", "Thiên tử thể trạng", "Từ Chối");
    }
    private void ItemChiTon(Player pl, Item item) {//hop qua skh
        NpcService.gI().createMenuConMeo(pl, item.template.id, -1, "Hãy chọn chỉ số Chí Tôn", "Chí Tôn sát thương", "Chí Tôn huyết long", "Chí Tôn thể trạng", "Từ Chối");
    }
    private void ItemDHD(Player pl, Item item) {//hop qua do huy diet
        NpcService.gI().createMenuConMeo(pl, item.template.id, -1, "Hãy chọn một món quà", "Áo", "Quần", "Găng", "Giày", "Rada", "Từ Chối");
    }

    private void ItemDTL(Player pl, Item item) {//hop qua do than linh
        NpcService.gI().createMenuConMeo(pl, item.template.id, -1, "Hãy chọn một món quà", "Áo", "Quần", "Găng", "Giày", "Rada", "Từ Chối");
    }

    private void ItemSV(Player pl, Item item) {//hop qua 100k
        NpcService.gI().createMenuConMeo(pl, item.template.id, -1, "Hãy chọn một món quà", "SPL SĐ", "SPL HP", "SPL KI", "Từ Chối");
    }
